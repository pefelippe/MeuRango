export default {
  translations: {
    ...
    404: {
      ...
      backMessage: "Voltar para o Dashboard",
    },
    dashboard: {
      manage: "Gerenciar sua loja",
    ...
    pricing: {
      ...
      introduction:
        "O Meu Rango permite que você gerencie seus pedidos online de forma eficiente. Comece com nosso plano Básico e, conforme seu negócio cresce, faça o upgrade para um de nossos planos pagos para obter mais recursos, gerenciar mais pedidos, e receber suporte dedicado.",
      ...
      plans: {
        ...
        professional: {
          ...
          features: [
            ...
            "Cardápio personalizado com fotos",
        ...
        premium: {
          name: "Premium",
          price: "R$39,90",
          description: "Para estabelecimentos que buscam recursos avançados",
          features: [
            "Todos os recursos do plano Profissional",
            "IA para recomendações de pratos",
    ...
    faq: {
      ...
      useWithoutPaymentAnswer:
        "Sim, oferecemos um período de teste gratuito para que você possa experimentar nossa plataforma antes de se comprometer.",
      apiIntegration: "Posso usar APIs para integrar com o Meu Rango?",
      apiIntegrationAnswer:
        "Sim, fornecemos APIs para integração com sistemas existentes, permitindo uma experiência personalizada e eficiente.",
      embedChatbot: "Como posso incorporar o chatbot do Meu Rango no meu site?",
      embedChatbotAnswer:
        "Oferecemos um código de incorporação simples que você pode adicionar ao seu site para integrar nosso chatbot de atendimento ao cliente.",
      credits: "O que são os créditos do Meu Rango?",
      creditsAnswer:
